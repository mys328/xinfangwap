            ...
            <div class="span8">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form method="post" id="forgetpassword" name="forgetpassword" action="UserInfo_nologin?businessNUM=0012"
                              class="form-horizontal">
                            <div class="control-group1">

                                <img src="images/psw_step2.png" alt="" id="psw"/>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label">取回密码问题：</label>

                                <div class="controls">
                                    <s:property value="map.get('key')"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">取回密码答案：</label>

                                <div class="controls">
                                    <input type="text" name="tsmmda" id="tsmmda" maxlength="30" value="" class="span8"/>
