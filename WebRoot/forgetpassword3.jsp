            ...
            <div class="span8">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="UserInfo_nologin?businessNUM=0013" method="post" id="forgetpassword" name="forgetpassword"
                              class="form-horizontal">
                            <div class="control-group1">

                                <img src="images/psw_step3.png" alt="" id="psw"/>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label">请输入证件编号：</label>

                                <div class="controls">
                                    <input type="text"class="span8" name="zjbh" id="zjbh" maxlength="30" datatype="Require" msg="必填"/>
