...
<head>
    ...
    <script type="text/javascript">
        ...
        function check() {
            var elterpassword = document.getElementById("elterpassword");
            if (Validator.Validate(elterpassword, 3)) {
                elterpassword.submit();
            }
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        ...
        <li class="active"><a title="" href="UserInfo_password" target=""><i class="icon icon-lock"></i> <span class="text">修改密码</span></a>
        </li>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>导航菜单</a>
    <ul>
        ...
        <li class="active"><a href="UserInfo_password"><i class="icon icon-lock"></i> <span>修改密码</span></a></li>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"><a href="UserInfo_edit" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
            首页</a> <a href="#" class="tip-bottom">修改密码</a>
        </div>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="UserInfo_elter" method="post" id="elterpassword" name="elterpassword" class="form-horizontal" method="post">

                            <div id="form-wizard-1" class="step">
                                <div class="control-group">
                                    <label class="control-label">请输入原密码:</label>
                                    <div class="controls">
                                        <input type="password" name="ymm" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">请输入新密码:</label>
                                    <div class="controls">
                                        <input type="password" name="xmm" maxlength="21" datatype="Limit"
                                               min="6" max="20" msg="长度为6到20之间"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="password" name="xmm2" maxlength="21"
                                               datatype="Repeat" to="xmm" msg="与新密码保持一致"/>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="businessNUM" value="0005"/>
                            <div class="form-actions">
                                <input id="back" class="btn btn-primary" type="submit" value="确定" onclick="check()"/>
